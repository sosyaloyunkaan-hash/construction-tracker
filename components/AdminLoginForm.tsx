          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-3 pr-11 border border-slate-200 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-transparent"
              />
